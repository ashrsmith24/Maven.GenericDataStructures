...
//Write two methods, superCombiner and extendCombiner, which each take two arraylists
// and append all of the items from the second to the first.
// superCombiner should use ? super E and extendCombiner should use ? extends E.
